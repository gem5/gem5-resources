---
title: VEGA HSA Agent Packet Test
tags:
    - x86
    - amdgpu
layout: default
...
shortdoc: >
    Resources to build a disk image with the VEGA HSA Agent Packet workload.
---
...
docker run --rm -v ${PWD}:${PWD} -w ${PWD} -u $UID:$GID ghcr.io/gem5/gcn-gpu:v23-1 make gfx9-apu
```
